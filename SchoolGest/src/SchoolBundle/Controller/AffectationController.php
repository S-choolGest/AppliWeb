...
class AffectationController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $affectations = $em->getRepository('SchoolBundle:Affectation')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('SchoolBundle\Form\AffectationType', $affectation);
    ...
    {
        $deleteForm = $this->createDeleteForm($affectation);
        $editForm = $this->createForm('SchoolBundle\Form\AffectationType', $affectation);
